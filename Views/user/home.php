                            ...
                            <ul class="header_bottom-list">
                                ...
                                <!-- <li class="header_bottom-item">
                                    <a href="" class="header_bottom-link">
                                        <img src="../../img/icon/ico_2.webp" alt="">
                                        Laptop - Laptop Gaming
                                    </a>
                                </li>
                                <li class="header_bottom-item">
                                    <a href="" class="header_bottom-link">
                                        <img src="../../img/icon/ico_3.webp" alt="">
                                        Máy giặt - Máy sấy
                                    </a>
                                </li>
                                <li class="header_bottom-item">
                                    <a href="" class="header_bottom-link">
                                        <img src="../../img/icon/ico_4.webp" alt="">
                                        Tivi - Loa âm thanh
                                    </a>
                                </li>
                                <li class="header_bottom-item">
                                    <a href="" class="header_bottom-link">
                                        <img src="../../img/icon/ico_h_5.webp" alt="">
                                        Điều hòa nhiệt độ
                                    </a>
                                </li>
                                <li class="header_bottom-item">
                                    <a href="" class="header_bottom-link">
                                        <img src="../../img/icon/ico_6.webp" alt="">
                                        Gia dụng - Thiết bị bếp
                                    </a>
                                </li>
                                <li class="header_bottom-item">
                                    <a href="" class="header_bottom-link">
                                        <img src="../../img/icon/ico_7.webp" alt="">
                                        Thiết bị văn phòng
                                    </a>
                                </li>
                                <li class="header_bottom-item">
                                    <a href="" class="header_bottom-link">
                                        <img src="../../img/icon/ico_8.webp" alt="">
                                        Kĩ thuật số
                                    </a>
                                </li>
                                <li class="header_bottom-item">
                                    <a href="" class="header_bottom-link">
                                        <img src="../../img/icon/ico_9.webp" alt="">
                                        Phụ kiện
                                    </a>
                                </li> -->
                            </ul>
                    ...
                    <section class="header_banner">
                        <ul class="header_banner-policy">
                            <li class="header_banner-policy-item"><a class="header_banner-policy-text" href="">
                                    <img src="../../img/icon/icon/gift.png" alt="">
                        ...
                        <div class="slideshow-container">
                            ...
                            <div class="mySlides fade">
                                ...
                                <img src="../../img/banner/slider_1.webp" style="width:100%">
                                <div class="text">Caption Text</div>
                            </div>

                            <div class="mySlides fade">
                                <div class="numbertext">2 / 3</div>
                                <img src="../../img/banner/mau-banner-dien-may-dep-va-chuyen-nghiep_024310892.jpg" style="width:100%">
                                <div class="text">Caption Two</div>
                            </div>

                            <div class="mySlides fade">
                                <div class="numbertext">3 / 3</div>
                                <img src="../../img/banner/anh-thiet-ke-banner-dien-may_033704372.jpg" style="width:100%">
                           ...
                           <?php  foreach($news as $new): ?>
                                ...
                                <a href="./index.php?act=sanphamchitiet&id=<?php echo $new["id_sanPham"] ?>">
                                    <article class="product_not_sell">
                                        <section class="product_img">
                                            <img src="../../img/<?php echo $new["image"]?>"
                                                alt="">
                                        </section>
                            ...
                            <!-- <section class="column">
                                <a href="">
                                    <article class="product_not_sell">
                                        <section class="product_img">
                                            <img src="../../img/prodcut/636863636051023338-ss-galaxy-s10-plus-den-1.webp"
                                                alt="">
                                        </section>
                                        <section class="product_name">
                    ...
                    <section class="product_item product_new">
                        ...
                        <section class="row product-hot ">
                            <?php foreach($views as $view) : ?>
                                ...
                                <article class="product_not_sell">
                                        <section class="product_img">""
                                            <img src="../../img/<?php echo $view["image"]?>"
                                                alt="">
                                        </section>
                                        <section class="product_name">
