<section class="header_bottom">
        ...
        <section class="container ">
            ...
            <section class="sign_up">
                <form data-action="dangnhap" action="./index.php?act=active&id=<?php echo $_GET['id'] ?>" method="post" >
                        <h1>Quên mật khẩu</h1>
                        ...
                        <section class="form_signup">
                            <input type="text" class="active_user" name="vetification_user"  placeholder="******" required>
                            <br>
